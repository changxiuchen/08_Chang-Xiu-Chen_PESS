...
function Dispatched() {
  alert("You've dispatched a Patrolcar !" );
	...
	<form name="formdispatch" method="post" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>">
		...
		<table width="40%" border="2" align="center" cellpadding="4"  cellspacing="4">
			<tr>
			...
			<td>
				Location</td>
			<td><?php echo $_POST['location']?><input type="hidden" name="location" id="location" value="<?php echo $_POST['location']?>"></td></tr>
			<tr>
			<td>Incident Type:</td>
